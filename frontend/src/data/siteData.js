...
import ferrariRomaImage from '../assets/vehicle-ferrari-roma.png'
import f150Image from '../assets/vehicle-f150.png'
import lamborghiniUrusImage from '../assets/vehicle-lamborghini-urus.png'
import mercedesG63Image from '../assets/vehicle-mercedes-g63.png'
import rollsRoyceCullinanImage from '../assets/vehicle-rolls-royce-cullinan.png'
...
export const featuredVehicles = [
  ...
  },
  {
    ...
    title: 'Clean title',
    status: 'Green light',
    seller: 'Luxury dealer consignment',
    light: 'Green light',
    transmission: 'Automatic',
    drivetrain: 'AWD',
    notes: 'Black exotic SUV, panoramic roof, carbon interior package, performance exhaust, documented service history.',
  },
  {
    id: 'lot-2202',
  ...
  },
  {
    ...
    vin: 'SCA689X5***2203',
    title: 'Clean title',
    status: 'Luxury consignment',
    seller: 'Private seller',
    light: 'Green light',
    transmission: 'Automatic',
    drivetrain: 'AWD',
    notes: 'Silver ultra-luxury SUV, rear comfort package, premium audio, soft-close doors, sale packet verified.',
  },
  {
    id: 'lot-2204',
    image: ferrariRomaImage,
    year: '2022',
    make: 'Ferrari',
    model: 'Roma',
    category: 'Cars',
    ...
    transmission: 'Automatic',
    drivetrain: 'RWD',
    notes: 'Red grand touring coupe, carbon steering wheel, upgraded wheels, clean history, title on site.',
  },
]
